    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(choices=[('Sistemas', 'Sistemas'), ('Tesorería', 'Tesorería'), ('Crédito', 'Crédito'), ('Dirección General', 'Dirección General'), ('Economía', 'Economía'), ('Negocio', 'Negocio'), ('Aseguramiento', 'Aseguramiento')], help_text='Entre el área a la que pertenece', max_length=50, verbose_name='Área')),
